...
3. Add the three fields always discovered too late: the **raw input artifact**, a **per-item
   status** kept separate from the score, and the **fully resolved config** including serving
   path and tool manifest.
