...
every tool/MCP call with inputs+outputs — to Braintrust. A working example of the
env setup and parent-span nesting is `rag-only-enforcement/run_eval.py`, at the
repo root.
